"""Tests for the JSON-list parsing helper shared by Compliance/Governance agents.

check_framework_controls/compare_controls themselves are Bedrock calls and
aren't unit-tested here without mocking the client (mirrors this codebase's
existing scope for LLM-calling nodes) — this covers the deterministic
response-parsing path those nodes depend on.
"""
import os
